sap.ui.define(
    ...
    "gestioneabilitazioneeson.controller.DeleteSignSON",
    {
        formatter: formatter,
        _beneficiario:null,
        ...
        onInit: function () {
            ...
            self.getRouter().getRoute("deleteSignSON").attachPatternMatched(self._onObjectMatched, self);
        ...
        _onObjectMatched: function (oEvent) {
            ...
            if (checkList && checkList.length === 1) {
                ...
                self.fillWizard(checkList[0],"gestioneabilitazioneeson.view.DeleteSignSON");
              }
            setTimeout(() => {                
        ...
        onSelectTab: function (oEvent) {
            ...
            onNavBack:function(oEvent){
                var self = this;
                self.resetForBack("btnDeleteSign",false);
                self.resetLog();
            ...
            switch(key){
                case oBundle.getText("btnDeleteSign"):
                    var oDialog = new sap.m.Dialog({
                        ...
                        content: [
                          new sap.m.Text({
                            text: oBundle.getText("msgDeleteSignSon"),
                          }),
                        ],
                        beginButton: new sap.m.Button({
                          ...
                          press: function () {
                            self.resetLog();
                            oDialog.close();
                            self.callDeep(OPERATION_TYPE_DELETE_SIGN);
                          }
                        }),
            ...
            if(key !== oBundle.getText("btnDeleteSign")){
                ...
                if (selectedItem !== null) {
                    ...
                    if(action === oBundle.getText("btnDetail")){
                        ...
                        self.getView().getModel(DETAIL_MODEL).setProperty("/buttonVisible",false);
                        self.fillWizard(oItem,"gestioneabilitazioneeson.view.DeleteSignSON");
                    }
