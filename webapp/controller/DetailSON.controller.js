    ...
    return BaseController.extend(
      "gestioneabilitazioneeson.controller.DetailSON",
      {
        ...
        _onObjectMatched: function (oEvent) {
          ...
          if (
            self.getModelGlobal("checkList") === undefined ||
            self.getModelGlobal("actionModel") === undefined
          ) {
          ...
          self
            ...
            .setProperty(
              "/headerVisible",
              key === oBundle.getText("btnDetail") ? true : false
            );
          ...
          switch (key) {
            ...
            case oBundle.getText("btnSendSign"):
              ...
              self
                .getView()
                .getModel(DETAIL_MODEL)
                .setProperty("/buttonText", oBundle.getText("btnTextSendSign"));
              self
                .getView()
                .getModel(DETAIL_MODEL)
                .setProperty("/buttonVisible", true);
            ...
            case oBundle.getText("btnDeleteSendSign"):
              self
                ...
                .setProperty(
                  "/buttonText",
                  oBundle.getText("btnTextDeleteSendSign")
                );
              self
                .getView()
                .getModel(DETAIL_MODEL)
            ...
            case oBundle.getText("btnSign"):
              self
                .getView()
                .getModel(DETAIL_MODEL)
                .setProperty("/buttonText", oBundle.getText("btnTextSignSON"));
              self
                .getView()
                .getModel(DETAIL_MODEL)
                .setProperty("/buttonVisible", true);
            ...
            case oBundle.getText("btnRegisterCancel"):
              self
                ...
                .setProperty(
                  "/buttonText",
                  oBundle.getText("btnTextRegisterCancel")
                );
              self
                .getView()
                .getModel(DETAIL_MODEL)
            ...
            case oBundle.getText("btnDeleteCancel"):
              self
                .getView()
                .getModel(DETAIL_MODEL)
                .setProperty("/buttonText", oBundle.getText("btnDeleteCancel"));
              self
                .getView()
                .getModel(DETAIL_MODEL)
                .setProperty("/buttonVisible", true);
            ...
            case oBundle.getText("btnDeleteSign"):
              self
                ...
                .setProperty(
                  "/buttonText",
                  oBundle.getText("btnTextDeleteSign")
                );
              self
                .getView()
                .getModel(DETAIL_MODEL)
        ...
        onAction: function (oEvent) {
            ...
            case oBundle.getText("btnRegisterCancel"):
              ...
              objectParams = {
                ...
                CdrRicann: self
                  ...
                  .getModel(HEADER_ACTION_MODEL)
                  .getProperty("/Zcdr"),
                ZdirigenteRicann: self
                  .getView()
                  .getModel(HEADER_ACTION_MODEL)
                  .getProperty("/ZdirigenteAmm"),
              };
              successContent =
                oBundle.getText("operationOK") +
                "/n" +
                "Richiesta di annullamento registrata per il SON N. " +
                son;
              break;
            case oBundle.getText("btnDeleteCancel"):
          ...
          if (
            key === oBundle.getText("btnDetail") ||
            key === oBundle.getText("btnWorkflow")
          ) {
        ...
        onSendSignUpdateDate: function () {
          ...
          self
            .getView()
            .getModel(DETAIL_MODEL)
            .setProperty("/changeList", checkList);
        },
        ...
        callDeep: function (
          ...
          if (hasChangeList) checklist = detailModel.getProperty("/changeList");
