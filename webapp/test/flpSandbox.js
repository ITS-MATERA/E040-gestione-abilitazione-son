		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestione Abilitazione",
									"targetURL": "#gestioneabilitazioneeson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gestioneabilitazioneeson-display": {
								"semanticObject": "gestioneabilitazioneeson",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gestioneabilitazioneeson",
									"url": sap.ui.require.toUrl("gestioneabilitazioneeson")
								}
							}
						}
					}
